...
export default function EventsEnPage() {
  ...
  return (
    <div className="p-6 space-y-6">
          ...
          {timeline && (timeline.active || []).length > 0 && (
            <div className="space-y-3">
              {(timeline.active || []).map((e: any) => {
                ...
                return (
                  <div key={e.eventId} className="border border-white/10 rounded-xl p-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <div>
      ...
      <NeonCard>
        <div className="p-4">
          <div className={classes.accent}>Upcoming</div>
      ...
      <NeonCard>
        <div className="p-4">
          <div className={classes.accent}>Ended</div>
          <div className="space-y-3 mt-3">
      ...
      {isConnected && (
        <NeonCard>
          <div className="p-4">
            <div className={classes.accent}>My History</div>
            <div className="space-y-3 mt-3">
              {(history || []).map((h: any) => (
                <div key={`${h.eventId}:${h.completedAt}`} className="border border-white/10 rounded-xl p-3 flex items-center justify-between">
                  ...
                  <div className={`text-xs ${h.claimed ? "text-green-300" : "text-white/60"}`}>{h.claimed ? "Claimed" : "Unclaimed"}</div>
                </div>
              ))}
            </div>
          </div>
