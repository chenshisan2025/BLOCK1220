...
export default function ZhDocs() {
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <NeonCard>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
          ...
          <NeonCard><div className="flex items-center gap-2"><NeonIcon icon={Ban}/><h3 className={classes.accent}>Empty</h3></div><p>暂无文档</p></NeonCard>
